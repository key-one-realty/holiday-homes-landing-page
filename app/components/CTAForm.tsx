...
const CTAForm = () => {
  ...
  return (
    <div className="form flex justify-center items-center">
      <form
        className="CTA_form bg-white rounded-lg w-[81.481vw] pb-6 -mt-[2%] xs:-mt-[3%] sm:-mt-[5%] md:-mt-[2%] lg:-mt-10 xl:-mt-14 2xl:-mt-44 shadow"
        onSubmit={(e) => handleSubmit(handleSubmitForm)}
      >
        {apiSuccess && (
        ...
        <div className="form-container flex flex-col justify-start py-4 px-5 gap-4">
          <h2 className="text-sm text-accent-purple ">
            ...
            <span className="font-bold">
              how much you can maximize your income
            </span>{" "}
            with Key One Holiday Homes
          </h2>
          ...
          <div className="form-group flex flex-col gap-4">
            <div
              ...
              } "personal-info flex lg:grid lg:grid-cols-3 justify-center items-center flex-col md:flex-row gap-2 lg:gap-6 w-full"`}
            >
              <InputField
                label="Name"
                inputType="text"
              ...
              <div className="flex flex-col md:flex-row justify-start items-center w-full gap-6">
                <div
                  className={`w-full md:w-8/12 gap-2 ${
                    step !== 3 ? "hidden md:flex" : "flex"
                  } "message flex-col justify-center items-start"`}
                >
                  <label
                    htmlFor="message"
                  ...
                  <div className="input px-[10px] py-3  w-full md:w-[50vw] bg-input-bg flex justify-start items-center rounded-[10px]">
                    <textarea
                      {...register("additional_fields.0.Message", {
                        required: false,
                      })}
                      id="message"
                ...
                {step == 3 ? (
                  ...
                  <button
                    className="bg-accent-purple w-full md:w-4/12 lg:w-[24.405vw] text-white py-3 px-5 rounded-lg mt-4"
