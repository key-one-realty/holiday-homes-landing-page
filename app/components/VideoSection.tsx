...
const VideoSection = () => {
    ...
    const handleModalScroll = () => {
        if (play) {
            ...
            if (modalContainerRef.current) { // Check if modalContainerRef.current is not null
                ...
                <div className="lhs video-container bg-opacity-30 rounded-[10px] bg-lime-500 w-full lg:w-[35.402vw] h-[52.953vh] flex justify-start items-center">
                    <div className="relative w-[90vw] lg:w-[35.865vw] h-[50.314vh]">
                        ...
                        <div className="play-button flex justify-center items-center absolute top-1/2 transform translate-x-[32.02vw] md:translate-x-[38.02vw] lg:translate-x-[32.02vw]  -translate-y-1/2 cursor-pointer">
                            <div className="w-[20vw] md:w-[9.259vw] h-[14.257vh] relative cursor-pointer" onClick={handlePlayBtn}>
                ...
                play && (
                    <div className='flex flex-col'>
                        <div className="video-player text-center" ref={modalContainerRef}>
                            <div ref={videoRef}>
                                <p className='md:w-[53svw] text-right text-white cursor-pointer' onClick={() => setPlay(false)}>Close</p>
                                <ReactPlayer width={'100%'} style={{
                                    maxHeight: '50svh'
                                }} height={'50svh'} url='https://www.youtube.com/watch?v=TvtVDwwRnSY&ab_channel=KeyOneHolidayHomes' fallback={<LoadingIcon />} playing={play} />
                            </div>
                        </div>
                    </div>
