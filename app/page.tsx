...
export default function Home() {
  const CTAForm2Ref = useRef(null);

  const handleSmoothScroll = () => {
    if (CTAForm2Ref.current) {
      (CTAForm2Ref.current as HTMLElement).scrollIntoView({
        behavior: "smooth",
      });
    }
  };
  ...
  return (
    <main className="flex min-h-screen flex-col items-center w-full">
        ...
        <div className="bg-hero-section bg-cover bg-center h-[60vh] xs:h-[58vh] lg:h-[60vh] xl:h-[50vh] w-full max-w-[81.481vw] ">
          ...
          <div className="hero-section-contents mt-10 flex flex-col gap-2 text-white">
            ...
            <p className="text-base md:text-xl lg:w-[58.135vw]">
              Maximize your investment and let our dedicated team at Key One
              Holiday Homes handle the details, ensuring a seamless renting
          ...
          <div className="benefits-cards flex flex-col lg:flex-row justify-center lg:justify-between w-full items-center lg:items-start gap-20">
            <div className="benefit-card xs:w-[300px] flex flex-col justify-center items-center gap-4">
              ...
              <p className="text-text-color text-justify sm:text-sm xl:text-base">
                Our professional photography and marketing team will ensure your
                property is showcased in the best light.
              </p>
            </div>
            <div className="benefit-card xs:w-[300px] flex flex-col justify-center items-center gap-4">
              <Image
                src="/office chair.svg"
                alt="benefit-2"
                width={64}
                height={64}
              />
              ...
              <p className="text-text-color text-justify sm:text-sm xl:text-base">
                Increased efficiency and more time for what matters - that is
                what Key One Holiday Homes promises you with comprehensive short
                term rental property management solutions.
              </p>
            </div>
            <div className="benefit-card xs:w-[300px] flex flex-col justify-center items-center gap-4">
              <Image
              ...
              <p className="text-text-color text-justify sm:text-sm xl:text-base">
                With Key One Holiday Home’s comprehensive suite of services,
                ensuring seamless bookings, top-notch guest experiences, and a
                worry-free income stream you can confidently entrust your
                vacation home, knowing that every detail is handled with
                precision and care.
              </p>
            </div>
          </div>
            ...
            <div className="service-cards flex flex-wrap justify-center lg:grid justify-items-center gap-7 w-full">
              <div className="shadow service-card w-full md:w-8/12 lg:w-[25.926vw]  flex flex-col justify-center rounded-[10px] items-center gap-4 py-12">
                <Image
                  ...
                  height={45}
                />
                <h3 className="text-xl font-semibold text-text-color text-center">
                  24/7 Customer Support
                </h3>
                <p className="text-text-color text-center px-7 text-sm xl:text-base">
                  Experience peace of mind with our around-the-clock customer
                  service, ensuring your needs are met and any queries are
                  resolved promptly
                </p>
              </div>
              <div className="shadow service-card w-full md:w-8/12 lg:w-[25.926vw] flex flex-col justify-center rounded-[10px] items-center gap-4 py-12">
                ...
                <p className="text-text-color text-center px-7 text-sm xl:text-base">
                  From maintenance and bookings to guest interactions and
                  financial matters - we manage your property with precision in
                  every detail
                </p>
              </div>
              <div className="shadow service-card w-full md:w-8/12 lg:w-[25.926vw]  flex flex-col justify-center rounded-[10px] items-center gap-4 py-12">
                <Image
                  src="/person female.svg"
                  alt="service-2"
                  width={45}
                  height={45}
                />
                ...
                <p className="text-text-color text-center px-7 text-sm xl:text-base">
                  Our short term rental cleaning and maintenance team is
                  dedicated to keeping your property in pristine condition
              ...
              <div className="shadow service-card w-full md:w-8/12 lg:w-[25.926vw] flex flex-col justify-center rounded-[10px] items-center gap-4 py-12">
                ...
                <p className="text-text-color text-center px-7 text-sm xl:text-base">
                  At Key One Design Solution, we excel in turning your holiday
                  home into a refined and comfortable retreat through our
              ...
              <div className="service-card w-full md:w-8/12 lg:w-[25.926vw]  flex flex-col justify-center rounded-[10px] items-center gap-4 py-12">
                ...
                <p className="text-text-color text-center px-7 text-sm xl:text-base">
                  Ensure your investment gets the spotlight it deserves in the
                  competitive market with our cutting-edge vacation rental
              ...
              <div className="shadow service-card w-full md:w-8/12 lg:w-[25.926vw]  flex flex-col justify-center rounded-[10px] items-center gap-4 py-12">
                ...
                <p className="text-text-color text-center px-7 text-sm xl:text-base">
                  Ensure a seamless and memorable stay for both guests and hosts
                  alike with our highly-rated hospitality services
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="flex flex-col gap-12 justify-center items-center w-full">
        <h1 className="text-center text-text-color text-[27.65px] lg:text-[40px] font-extrabold">
      ...
      <section className="cta-valuation flex flex-col gap-8 justify-center items-center py-28 w-full">
        <div className="max-w-[81.481vw] w-full flex flex-col justify-center items-center gap-8">
          ...
          <div className="text-sm lg:text-xl text-text-color text-justify md:text-center">
            <p>
              Experience less stress and more freedom with our property
              management services. Let us handle late-night emergencies,
              paperwork, and tedious tasks, allowing you to focus on quality
              time with loved ones. Efficiently managing your portfolio,
              minimizing delays, and negotiating favorable rates, we enhance
              your property&apos;s profitability, ensuring more money in your
              pocket.
            </p>
          </div>
        </div>
        <MobileCTAForm CTAForm2Ref={CTAForm2Ref} />
      </section>
      <VideoSection />
      <section className="mockup flex gap-8 justify-center items-center py-28 w-full bg-lime-500 bg-opacity-30">
        <div className="max-w-[81.481vw] flex flex-col lg:flex-row md:justify-between xl:justify-evenly items-center gap-8">
          <div className="mockup -mt-52 lg:mt-0 w-10/12 h-[376px] md:w-7/12 relative">
            <Image
              src="/landlord-portal-mockup.png"
          ...
          <div className="mockup-text flex flex-col gap-11 justify-center items-center lg:items-start w-full lg:w-6/12">
            ...
            <div className="app-benefits grid md:grid-cols-2 justify-items-center gap-x-12 gap-y-12">
              <div className="benefit text-center lg:text-left">
                <h1 className="text-2xl font-semibold">Live Calendar</h1>
      ...
      <section className="partners flex flex-col gap-8 justify-center items-center py-28 w-full">
        <div className="max-w-[81.481vw] w-full flex flex-col justify-center items-center gap-8">
          ...
          <div className="mt-12">
            <button
              className="p-3 px-10 rounded-[10px] w-full lg:w-[28.902vw] font-bold bg-accent-purple text-white"
